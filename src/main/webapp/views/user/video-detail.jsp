...
<body>
    ...
    <div class="container-fluid tm-container-content tm-mt-60">
        <div class="row mb-4">
            ...
            <h2 class="col-12 tm-text-primary"><i class="fab fa-youtube-square mr-1"></i> ${video.title} </h2>
        </div>
        <div class="row tm-mb-90">            
            <div class="col-xl-8 col-lg-7 col-md-6 col-sm-12">
             <iframe id="tm-video" style=" display:block; width: 100%; height: 600px;" src="https://www.youtube.com/embed/${video.href}"></iframe>
            ...
            <div class="col-xl-4 col-lg-5 col-md-6 col-sm-12">
                <div class="tm-bg-gray tm-video-details">
                    <c:if test="${not empty sessionScope.currentUser}">
                    	...
                    	<div class="text-center mb-5">
                        	<a href="#" class="btn btn-primary tm-btn-big"><i class="fas fa-share mr-2"></i>Share</a>
                    	</div>
                    </c:if>                    
                    <div class="mb-4">
