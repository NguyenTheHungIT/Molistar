...
public class VideoController extends HttpServlet{
	...
	//http://localhost:8080/NguyenTheHung/video?action=watch&id={href}
	...
	//http://localhost:8080/NguyenTheHung/video?action=like&id={href}
	private void doGetLike(HttpSession session, String href, HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		if (result == true) {
			resp.setStatus(204); // succed but no response data
